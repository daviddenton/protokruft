...
Optionally, you can also add a `markerInterface` option to aid IDE navigability - this interface is NOT generated and must be created by the Protokruft user.
